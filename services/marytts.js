...
module.exports = function(host, port) {
    ...
    // for testing
    _url = 'http://holiday.twelpful.net/';
	...
	function _process(text, options, callback) {
		// console.log(text,options,callback);
		...
		data['effect_Volume_selected'] = 'on';
		data['effect_Volume_parameters'] = 'amount:2.0'
